...
def get_conv2d(
    ...
    if type(kernel_size) is int:
        ...
        use_large_impl = kernel_size[0] * kernel_size[1] > 25
...
class ParC_V2(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # self.dwconv = Conv2d(med_channels // 2, kernel_size)
...
class ParC_V2_add(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        # self.dwconv2 = Conv2d(med_channels // 2, kernel_size)
        self.pwconv2 = nn.Conv2d(med_channels // 2, dim, 1, bias=bias)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.dwconv = get_conv2d(
            ...
            padding=(global_kernel_size - 1) // 2,
            groups=med_channels // 2,
            bias=bias,
        )  # depthwise conv
        self.pwconv2 = nn.Conv2d(med_channels // 2, dim, 1, bias=bias)
...
class Mlp(nn.Module):
    """MLP as used in ParCNetV2 models. Mostly copied from timm.
    """
...
def parcnetv2_tiny(pretrained=False, **kwargs):
    model = ParCNetV2(
        depths=[3, 3, 12, 3],
        dims=[64, 128, 320, 512],
        token_mixers=[ParC_V2_add, ParC_V2_merge, ParC_V2_merge, ParC_V2_merge],
        mlps=partial(BGU, mlp_ratio=5),
        **kwargs,
    )
    model.default_cfg = default_cfgs["convformer_s18"]
