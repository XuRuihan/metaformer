...
@register_model
def parcnetv2_5_dqu_s12(pretrained=False, **kwargs):
    model = MetaFormer(
        depths=[2, 2, 6, 2],
        dims=[64, 128, 384, 672],
        # dims=[64, 144, 384, 640],
...
@register_model
def parcnetv2_5_dqu2_s12(pretrained=False, **kwargs):
    model = MetaFormer(
        depths=[2, 2, 6, 2],
        dims=[96, 192, 448, 672],
        # dims=[64, 128, 320, 512],
...
@register_model
def parcnetv2_5_dqu_s18(pretrained=False, **kwargs):
    model = MetaFormer(
        depths=[3, 3, 9, 3],
        dims=[64, 128, 384, 672],
        downsample_layers=DOWNSAMPLE_LAYERS_FOUR_STAGES_GROUP,
...
@register_model
def parcnetv2_5_dqu2_s18(pretrained=False, **kwargs):
    model = MetaFormer(
        depths=[3, 3, 9, 3],
        dims=[96, 192, 448, 672],
        # depths=[3, 3, 12, 3],
